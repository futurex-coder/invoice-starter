...
async function getPostgresURL(): Promise<string> {
  ...
  const dbChoice = await question(
    'Choose your Postgres setup:\n' +
      '  (L) Local Postgres with Docker\n' +
      '  (S) Supabase\n' +
  ...
  if (choice === 'l') {
    ...
    console.log(
      '\nTo get your Supabase connection string:\n' +
        ...
        '  5. Copy the URI under "Connection pooling" (port 6543)\n' +
        '  6. Replace [YOUR-PASSWORD] with your database password\n'
    );
    return await question('Enter your Supabase POSTGRES_URL: ');
  } else {
    console.log(
